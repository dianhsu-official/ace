...
CREATE TABLE IF NOT EXISTS language (id INTEGER PRIMARY KEY AUTOINCREMENT, alias TEXT UNIQUE, suffix TEXT UNIQUE, platform TEXT, key TEXT, submit_language_id TEXT, submit_language_description, template_path TEXT default \"\", compile_command TEXT default \"\", execute_command TEXT default \"\", clear_command TEXT default \"\");
";
impl ConfigDatabase {
